...
| 유전자 | SMR p | HEIDI p | COLOC PP4 | COLOC PP3 | 판정 |
|---|---|---|---|---|---|
| SLC12A5 | 3.6e-14 | 0.20 | 0.996 | 0.004 | 삼중 확증 인과(최강) |
| FURIN | 1.8e-12 | 0.002 | 1.00 | 8.6e-08 | COLOC 지지, HEIDI 불일치 |
| DCC | 7.4e-11 | 0.28 | 0.72 | 0.28 | 시사적 인과 |
| NEGR1 | 1.0e-8 | 0.39 | 8.5e-07 | 1.00 | 불일치(SMR/HEIDI 통과, COLOC 별개) |
| GPX1 | 3.6e-13 | 0.008 | 0.194 | 0.806 | 비공존 |
| DRD2 | 0.024 | 0.003 | 2.9e-12 | 1.00 | 세 방법 모두 기각 |
