...
unambiguously correct on the text: ``the earlier the first trauma exposure, the
\emph{lower} the [\textsuperscript{11}C]P943 BP\textsubscript{ND}'' (i.e.\ lower
tracer binding) and ``the cotwin with relatively \emph{higher} cortisol\dots\
evinced \emph{lower} connectivity''---both are higher-stress$\to$lower-metric
correlations that the cross-check mis-valenced. The other two are genuinely
